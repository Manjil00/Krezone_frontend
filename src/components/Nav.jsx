...
<nav className="flex justify-between px-6 py-1 relative z-100  bg-white">
    ...
    <div className={`absolute min-h-[30vh] left-0 top-[50px] w-full p-5 flex flex-col md:static md:flex bg-white md:bg-transparent md:min-h-fit md:w-auto gap-9 text-sm ${isNavOpen ? 'block' : 'hidden'}`}>
