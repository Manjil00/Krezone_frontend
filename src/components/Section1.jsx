...
<div className="Section1 h-auto w-full mt-3 md:mt-8 bg-white relative z-0 ">
    <img src="../images/image 117.png" className="absolute inset-0 h-full w-full object-cover z-0" alt="bg"/>

    <div className="herosection grid grid-cols-1 md:grid-cols-3 relative z-10">

    <div className="leftSection flex flex-col justify-start items-start ml-16 mt-5 gap-5">
    ...
    <div className="rightSection flex">
        ...
        <img src="../images/hero photo.png" className="bg-white ml-60  p-3 md:block hidden h-auto w-auto z-20" alt="herophoto"/>
        <img src="../images/mobileframe.png" className="bg-white ml-5 p-3 md:hidden block h-auto w-auto z-20" alt="herophoto"/>
